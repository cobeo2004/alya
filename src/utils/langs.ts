...
const appLanguageSet = new Set<string>(SUPPORTED_APP_LANGUAGES);

export function isSupportedAppLanguage(value: string): value is SupportedAppLanguage {
  return appLanguageSet.has(value);
}

export function getSupportedAppLanguage(lang: string): SupportedAppLanguage | undefined {
  return isSupportedAppLanguage(lang) ? lang : undefined;
}

interface AppLanguageConfig {
  code2: SupportedAppLanguage;
  name: string;
}

// A list of the app's supported languages
export const SUPPORTED_APP_LANGUAGES_CONFIG: AppLanguageConfig[] = [
  ...
  { code2: 'ne', name: 'Nepali' },
  { code2: 'ru', name: 'Русский – Russian' },
  { code2: 'vi', name: 'Tiếng Việt – Vietnamese' },
  { code2: 'zh-CN', name: '简体中文 – Simplified Chinese' },
  { code2: 'zh-HK', name: '繁體中文 – Traditional Chinese (Hong Kong)' },
  { code2: 'zh-TW', name: '繁體中文 – Traditional Chinese (Taiwan)' },
];

// A comprehensive list of ISO languages used for general mapping purposes
